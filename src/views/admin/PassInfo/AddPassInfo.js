...
export default function AddPassInfo(props) {
  if(!props.show){
    return null;
  }
              ...
              <form className="">
                <div className="grid grid-cols-2 gap-4 mb-3">
                  ...
                  <div>
                    {" "}
                    <select
                      className="bg-white border duration-150 ease-linear focus:outline-none focus:ring placeholder-blueGray-300 px-3 py-3 rounded-lg text-blueGray-600 text-sm transition-all w-full"
                    >
