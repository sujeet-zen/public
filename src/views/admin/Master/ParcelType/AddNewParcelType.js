...
export default function AddNewParcelType(props) {
  ...
  const handleChange = (e) => {
    setParcelType({ ...parcelType, [e.target.name]: e.target.value })
  }
  ...
  const submitHandler = async () => {
    if (
      ...
      try {
        const parcelTypeRes = await axios({
