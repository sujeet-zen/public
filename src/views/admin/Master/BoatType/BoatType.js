...
import EditBoatType from "./EditBoatType";
import AddNewBoatType from "./AddNewBoatType";
// import '../../../../App.css'
...
const BoatType = () => {
  ...
  const data = useMemo(() => boatTypes, [boatTypes]);
  return (
    <>
      <Layout>
        <div className="sm:-mt-40 w-full">
          <div className="min-h-screen bg-white text-gray-900 shadow-lg rounded-3xl">
            <main className=" mx-auto px-4 sm:px-6 lg:px-8 pt-4">
              ...
              <div className="mt-6">
                <div className="flex flex-row">
                  <AddNewBoatType onClose={() => setShow(false)} show={show} />
                  <EditBoatType onClose={handleClose} edit={edit} selectedRowData={selectedRowData} />                                  
                </div>
