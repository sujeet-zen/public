...
export default function AddNewBoatCategory(props) {
  ...
  //   setBoatCategory({ ...boatCategory, [e.target.name]: e.target.value })
  // } 
  ...
  const submitHandler = async () => {
    if (
      ...
      try {
        const boatCategoryRes = await axios({
