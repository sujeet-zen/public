...
import AddNewBoatEntity from "./AddNewBoatEntity";
import EditBoatEntity from "./EditBoatEntity";
// import '../../../../App.css'
...
const BoatEntity = () => {
  const [boatEntities, setBoatEntities] = useState([]);
  ...
  const data = useMemo(() => boatEntities, [boatEntities]);
  return (
    <>
      <Layout>
        <div className="sm:-mt-40 w-full">
          <div className="min-h-screen bg-white text-gray-900 shadow-lg rounded-3xl">
            <main className=" mx-auto px-4 sm:px-6 lg:px-8 pt-4">
              ...
              <div className="mt-6">
                <div className="flex flex-row">
                  <AddNewBoatEntity onClose={() => setShow(false)} show={show} />
                  <EditBoatEntity onClose={handleClose} edit={edit} selectedRowData={selectedRowData} />                                  
                </div>
